    ...
    platformStyle(_platformStyle)
{
    ...
    // normal brocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying brocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BrocoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
