...
#ifndef BROCOIN_QT_SPLASHSCREEN_H
#define BROCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Brocoin Core initialization
...
#endif // BROCOIN_QT_SPLASHSCREEN_H
