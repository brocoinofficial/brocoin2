    ...
    mapper(nullptr)
{
    ...
    ui->brocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->brocoinAtStartup);
    ...
    ui->brocoinAtStartup->setToolTip(ui->brocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->brocoinAtStartup->setText(ui->brocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBrocoinConfButton->setToolTip(ui->openBrocoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BrocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->brocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBrocoinConfButton_clicked()
{
