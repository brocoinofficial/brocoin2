...
#ifndef BROCOIN_SCRIPT_STANDARD_H
#define BROCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a brocoin address
 */
...
/**
 * Generate a Brocoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BROCOIN_SCRIPT_STANDARD_H
