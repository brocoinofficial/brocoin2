...
static void SetupBrocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " brocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  brocoin-tx [options] <hex-tx> [commands]  Update hex-encoded brocoin transaction\n" +
            "or:     brocoin-tx [options] -create [commands]   Create hex-encoded brocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded brocoin transaction
