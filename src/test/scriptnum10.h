...
#ifndef BROCOIN_TEST_SCRIPTNUM10_H
#define BROCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Brocoin Core 0.10.0, for cross-comparison.
 */
public:
