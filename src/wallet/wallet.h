...
#ifndef BROCOIN_WALLET_WALLET_H
#define BROCOIN_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in bronees) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in bronees)
...
enum WalletFlags : uint64_t {
    ...
    //! brocoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Brocoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this brocoin node, and set to 0 for transactions that were created
...
public:
    ...
    /** Absolute maximum transaction fee (in bronees) used by default for the wallet */
