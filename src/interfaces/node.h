...
#ifndef BROCOIN_INTERFACES_NODE_H
#define BROCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a brocoin node (brocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BROCOIN_INTERFACES_NODE_H
