...
#ifndef BROCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BROCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@brocoin.
 *
 ...
 *
 * The chacha20-poly1305@brocoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@brocoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@brocoin are relatively fast in
...
#endif // BROCOIN_CRYPTO_CHACHA_POLY_AEAD_H
