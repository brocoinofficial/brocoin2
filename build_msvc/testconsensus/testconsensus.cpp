...
// brocoin includes.
#include <..\src\script\brocoinconsensus.h>
...
int main()
{
    std::cout << "brocoinconsensus version: " << brocoinconsensus_version() << std::endl;
    ...
    auto op0Result = brocoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, brocoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
