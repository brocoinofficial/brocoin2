...
class P2PPermissionsTests(BrocoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].brocoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].brocoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
