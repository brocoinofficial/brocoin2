...
By default, brocoind will dump mempool on shutdown and
...
class MempoolPersistTest(BrocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent brocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
