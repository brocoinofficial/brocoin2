...
"""Verify that starting brocoin with -h works as expected."""

from test_framework.test_framework import BrocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BrocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start brocoin with -h for help text")
        ...
        self.log.info("Start brocoin with -version for version information")
        ...
        self.log.info("Start brocoind with -fakearg to make sure it does not start")
