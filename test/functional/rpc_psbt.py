...
class PSBTTest(BrocoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BRON
        ...
        # feeRate of 0.1 BRON / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 BRON / KB produces a total fee well above -maxtxfee
