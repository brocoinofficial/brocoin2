...
This document provides guidelines for internationalization of the Brocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `brocoin_en.ts` remains unchanged.
