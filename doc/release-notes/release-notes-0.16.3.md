Brocoin Core version 0.16.3 is now available from:

  <https://brocoincore.org/bin/brocoin-core-0.16.3/>
...
been discovered in Brocoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` brocoinconsensus: invalid flags error should be set to `brocoinconsensus_err` (afk11)
