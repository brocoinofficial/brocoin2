Brocoin Core version 0.9.2.1 is now available from:

  https://brocoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BRON to 0.01 BRON
...
- Fix "Start brocoin on system login"
