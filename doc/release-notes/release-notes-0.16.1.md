Brocoin Core version 0.16.1 is now available from:

  <https://brocoincore.org/bin/brocoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting brocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure brocoind processes are cleaned up when tests end (sdaftuar)
