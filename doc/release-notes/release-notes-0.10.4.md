Brocoin Core version 0.10.4 is now available from:

  <https://brocoin.org/bin/brocoin-core-0.10.4/>
...
- #6953 `43c2789` Split brocoin-tx into its own package
- #6953 `dfe0d4d` Include brocoin-tx binary on Debian/Ubuntu
