Brocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/brocoin/files/Brocoin/brocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Brocoin
...
New/changed settings (command-line or brocoin.conf file)
--------------------------------------------------------
