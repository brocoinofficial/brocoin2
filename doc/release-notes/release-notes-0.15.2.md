Brocoin Core version *0.15.2* is now available from:

  <https://brocoincore.org/bin/brocoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in brocoin-tx (TheBlueMatt)
