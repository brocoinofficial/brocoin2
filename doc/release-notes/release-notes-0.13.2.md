Brocoin Core version 0.13.2 is now available from:

  <https://brocoin.org/bin/brocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update brocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow brocoin-tx to create v2 transactions (brondrak)
