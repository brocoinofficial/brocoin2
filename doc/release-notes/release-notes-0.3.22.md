Download URL: https://sourceforge.net/projects/brocoin/files/Brocoin/brocoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BRON fee schedule (users still pay 0.01 BRON per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #brocoin00 - #brocoin99
