Brocoin Core version 0.9.4 is now available from:

  https://brocoin.org/bin/0.9.4/
...
this update is incompatible with the Brocoin system and could lead to consensus
forks.

Brocoin Core released binaries from https://brocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~brocoin/+archive/ubuntu/brocoin
- A third-party or self-compiled Brocoin Core

upgrade to Brocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
