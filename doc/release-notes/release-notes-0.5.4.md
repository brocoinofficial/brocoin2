Brocoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/brocoin/files/Brocoin/brocoin-0.5.4/
...
http://gitorious.org/brocoin/brocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Brocoin-Qt notifications under Growl 1.3.
Increase required age of Brocoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBrocoin properly when installing Brocoin-Qt over it. (Windows)
