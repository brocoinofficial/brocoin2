...
(define* (make-brocoin-cross-toolchain target
                                  #:key
...
desirable for building Brocoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-brocoin-cross-toolchain "i686-linux-gnu")
       (make-brocoin-cross-toolchain "x86_64-linux-gnu")
       (make-brocoin-cross-toolchain "aarch64-linux-gnu")
       (make-brocoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-brocoin-cross-toolchain "riscv64-linux-gnu"
