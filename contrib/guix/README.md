# Bootstrappable Brocoin Core Builds

This directory contains the files necessary to perform bootstrappable Brocoin
Core builds.
...
- 24GB of free disk space on the partition that the Brocoin Core git repository
  resides in
...
For a Brocoin Core depends development environment, simply invoke
...
From the top of a clean Brocoin Core repository:
...
To use dongcarl's substitute server for Brocoin Core builds after having
