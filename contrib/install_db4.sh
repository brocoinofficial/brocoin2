...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the brocoin repository."
  exit 1
fi
...
# See https://github.com/brocoinofficial/brocoin/issues/16064
...
echo 'When compiling brocoind, run `./configure` in the following way:'
echo
